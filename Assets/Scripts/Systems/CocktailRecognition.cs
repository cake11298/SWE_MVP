...
namespace BarSimulator.Systems
{
    ...
    public class CocktailRecognition : MonoBehaviour
    {
        ...
        private void InitializeRecipes()
        {
            ...
            cubaLibre.AddIngredient("lime_juice", 0.1f);
            ...
            // 13. Long Island Iced Tea (Vodka+Rum+Gin+Tequila+TripleSec+Lemon+Cola)
            ...
            longIsland.AddIngredient("triple_sec", 1f);
            longIsland.AddIngredient("lemon_juice", 1f);
            ...
            // 17. Gimlet (Gin + Lime Juice)
            var gimlet = new CocktailRecipe("gimlet", "Gimlet", true, "CoupeGlass");
            gimlet.AddIngredient("gin", 4f);
            gimlet.AddIngredient("lime_juice", 1f); // Usually cordial, but juice + syrup works
            gimlet.AddIngredient("simple_syrup", 1f);
            recipes.Add(gimlet);

            // 18. Tom Collins (Gin + Lemon + Syrup + Soda)
            var tomCollins = new CocktailRecipe("tom_collins", "Tom Collins", true, "HighballGlass");
            tomCollins.AddIngredient("gin", 3f);
            tomCollins.AddIngredient("lemon_juice", 2f);
            tomCollins.AddIngredient("simple_syrup", 1f);
            ...
            // 20. Mai Tai (Rum + Dark Rum + Lime + Orange Curacao/Triple Sec + Orgeat/Syrup)
            var maiTai = new CocktailRecipe("mai_tai", "Mai Tai", true, "RocksGlass");
            maiTai.AddIngredient("rum", 2f);
            maiTai.AddIngredient("dark_rum", 1f); // Float
            maiTai.AddIngredient("lime_juice", 1f);
            maiTai.AddIngredient("triple_sec", 0.5f);
            maiTai.AddIngredient("simple_syrup", 0.5f);
            recipes.Add(maiTai);

            // 21. Sidecar (Brandy + Triple Sec + Lemon)
            var sidecar = new CocktailRecipe("sidecar", "Sidecar", true, "CoupeGlass");
            sidecar.AddIngredient("brandy", 4f);
            sidecar.AddIngredient("triple_sec", 2f);
            sidecar.AddIngredient("lemon_juice", 1.5f);
            recipes.Add(sidecar);

            // 22. Americano (Campari + Sweet Vermouth + Soda)
            var americano = new CocktailRecipe("americano", "Americano", false, "HighballGlass");
            americano.AddIngredient("campari", 1f);
            americano.AddIngredient("vermouth_sweet", 1f);
            americano.AddIngredient("soda", 2f);
            recipes.Add(americano);

            // 23. Boulevardier (Whiskey + Campari + Sweet Vermouth)
            ...
            boulevardier.AddIngredient("vermouth_sweet", 1f);
            recipes.Add(boulevardier);

            // 24. Kamikaze (Vodka + Triple Sec + Lime)
            var kamikaze = new CocktailRecipe("kamikaze", "Kamikaze", true, "ShotGlass");
            kamikaze.AddIngredient("vodka", 1f);
            kamikaze.AddIngredient("triple_sec", 1f);
            kamikaze.AddIngredient("lime_juice", 1f);
            recipes.Add(kamikaze);

            // 25. Lemon Drop (Vodka + Lemon + Syrup)
            var lemonDrop = new CocktailRecipe("lemon_drop", "Lemon Drop", true, "MartiniGlass");
            lemonDrop.AddIngredient("vodka", 4f);
            lemonDrop.AddIngredient("lemon_juice", 1.5f);
            lemonDrop.AddIngredient("simple_syrup", 1f);
